...
# ---------------------------------------------------------------
cd ~/parcial2_ws
colcon build --packages-select turtlebot3_dqn_nav
...
cd ~/parcial2_ws
source install/setup.bash
ros2 run turtlebot3_dqn_nav train_node
...
cd ~/parcial2_ws
source install/setup.bash
ros2 run turtlebot3_dqn_nav test_node
...
# ===============================================================
# ✔️ ESTADO ACTUAL DEL MODELO (trained_model.pkl)
# ===============================================================
...
# ✔ El sistema funciona dentro del mundo turtlebot3_world de Gazebo.
